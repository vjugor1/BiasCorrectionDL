...
def regrid(ds_in, scale_factor, periodic, align_target):
    ...
    if len(ds_target["latitude"])/scale_factor%2!=0:
...
def convert_nc2npz(
    ...
    # wthether data cover all the globe
    periodic=True
    ...
    regridder, grid_out = regrid(ds, scale_factor, periodic, align_target)
    lat = grid_out["lat"]
    lon = grid_out["lon"]
